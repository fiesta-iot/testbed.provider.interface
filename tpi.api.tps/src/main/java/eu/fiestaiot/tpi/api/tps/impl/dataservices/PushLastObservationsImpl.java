...
public class PushLastObservationsImpl {
	 ...
	 * 
	 * @return success message and the URL of the 
	 * 			stopPushOfObservations service
	 */
	public Response pushLastObservationResultSet() {
		String stopPushOfObservationsURL = "the_stop_push_of_observations_URL";

		return Response
				.ok("{\"response\" : \"Push_Schedule_ Successfully_Set_Up.\" , \n \"stopPushOfObservations\" : \""
						+ stopPushOfObservationsURL + "\"}")
				.build();
	}
}
